...
@section('title', 'زیادکردنی خوێندنگا')
...
<div class="page-header">
    <div>
        ...
        <div class="breadcrumb">
            <a href="{{ route('admin.institutions.index') }}">خوێندنگاکان</a> / نوێ
        </div>
    </div>
</div>
    ...
    <div class="inst-form-grid">
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nku" class="form-control" value="{{ old('nku') }}" required>
            </div>

            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                <div class="form-group">
                    <label class="form-label">ناو (ئینگلیزی)</label>
                    <input type="text" name="nen" class="form-control" dir="ltr" value="{{ old('nen') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">ناو (عەرەبی)</label>
                    <input type="text" name="nar" class="form-control" value="{{ old('nar') }}">
                </div>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                <div class="form-group">
                    ...
                    <select name="type" class="form-control" required>
                        ...
                        @foreach($types as $t)
                            <option value="{{ $t->key }}" {{ old('type') == $t->key ? 'selected' : '' }}>
                                {{ $t->emoji }} {{ $t->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control" dir="ltr" value="{{ old('phone') }}">
                </div>
                <div class="form-group">
        ...
        <div>
            <div class="card mb-4">
                ...
                <div class="form-group">
                    ...
                    <img id="logo-preview" class="img-preview" src="#" style="display: none; max-width: 100px; height: 100px; border-radius: 50%;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="cover-preview" class="img-preview" src="#" style="display: none; height: 100px; width: 100%;">
                </div>
            </div>
