...
class AppLocalizations {
  ...
  // Ads Carousel
  String get adDiplomaTitle => _t({
        'ku': 'سەنتەری دیپلۆمان',
        'kbd': 'سەنتەرێ دیپلۆمان',
        'ar': 'مركز الدبلومات',
        'en': 'Diploma Center',
        'tr': 'Diploma Merkezi'
      });
  ...
  String get adDiplomaTag => _t({
        ...
        'kbd': '🔥 تایبەت ب ئەڤ هەفتایێ',
        'ar': '🔥 عرض هذا الأسبوع',
        'en': '🔥 This Week Special',
        'tr': '🔥 Bu Haftaya Özel'
      });
  String get adComputerTitle => _t({
        'ku': 'پەیمانگای کۆمپیوتەر',
        'kbd': 'پەیمانگەهێ کۆمپیوتەر',
        'ar': 'معهد الحاسوب',
        'en': 'Computer Institute',
        'tr': 'Bilgisayar Enstitüsü'
      });
  String get adComputerSubtitle => _t({
        'ku': 'خولی فێربوونی پڕۆگرامسازی بۆ ئاستی سەرەتایی',
        'kbd': 'کۆرسێ فێربوونا پڕۆگرامسازی بۆ ئاستێ سەرەتایی',
        'ar': 'دورة تعلم البرمجة للمبتدئين',
        'en': 'Programming course for beginners',
        'tr': 'Yeni başlayanlar için programlama kursu'
      });
  String get adComputerTag => _t({
        'ku': '💻 خولی نوێ',
        'kbd': '💻 کۆرسێ نوێ',
        'ar': '💻 دورة جديدة',
        'en': '💻 New Course',
  ...
  String get adAmericanTitle => _t({
        'ku': 'زانکۆی ئەمریکی',
        'kbd': 'زانکۆیا ئەمریکی',
        'ar': 'الجامعة الأمريكية',
        'en': 'American University',
        'tr': 'Amerikan Üniversitesi'
      });
  String get adAmericanSubtitle => _t({
        'ku': 'دەرگای پێشکەشکردن کرایەوە بۆ ساڵی نوێ',
        'kbd': 'دەرگێ پێشکێشکرنی کرایە ڤەکرن بۆ سالا نوێ',
        'ar': 'باب القبول مفتوح للعام الجديد',
        'en': 'Admissions open for the new year',
        'tr': 'Yeni yıl kayıtları açık'
      });
  String get adAmericanTag => _t({
        'ku': '🎓 زانکۆ',
        'kbd': '🎓 زانکۆ',
        'ar': '🎓 جامعة',
        'en': '🎓 University',
